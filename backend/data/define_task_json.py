...
data = {
    "tasks": [
        {
            "title": "Print String Function",
            "description": "create a custom function to print a string to the screen",            "skeleton_code": """
#include <stdio.h>

/* To-Do: 문자열을 전달받으면, 화면에 출력하는 함수 print_str을 만들어보세요 */


int main(void)
{
        print_str("print function ok.\\n");
        return 0;
}
"""
        },
        {
            "title": "Print Single Digit",
            "description": "create a function to print a single integer digit from 0 to 9",
            "skeleton_code": """
#include <stdio.h>
...
"""
        ...
        {
            "title": "Print Two Digits with Leading Zeros",
            "description": "create a function to print numbers from 0 to 99 with padded leading zeros",
            "skeleton_code": """
#include <stdio.h>
...
"""
        ...
        {
            "title": "Print Two Digits without Leading Zeros",
            "description": "create a function to print numbers from 0 to 99 exactly as they are without padding",
            "skeleton_code": """
#include <stdio.h>
...
"""
        ...
        {
            "title": "Print Three Digits with Leading Zeros",
            "description": "create a function to print numbers from 0 to 999 with padded leading zeros",
            "skeleton_code": """
#include <stdio.h>
...
"""
        ...
        {
            "title": "Print Three Digits without Leading Zeros",
            "description": "create a function to print numbers from 0 to 999 exactly as they are without padding",
            "skeleton_code": """
#include <stdio.h>
...
"""
        ...
        {
            "title": "Print Ten Digits with Leading Zeros",
            "description": "create a function to print positive integers up to INT_MAX padded to 10 digits",
            "skeleton_code": """
#include <stdio.h>
...
"""
        ...
        {
            "title": "Print Positive Integers",
            "description": "create a function to properly print positive integers up to INT_MAX without padding",
            "skeleton_code": """
#include <stdio.h>
#include <limits.h>
...
"""
        ...
        {
            "title": "Print Negative Integers",
            "description": "create a function to properly print negative integers down to INT_MIN",
            "skeleton_code": """
#include <stdio.h>
#include <limits.h>
...
"""
        ...
        {
            "title": "Print Any 32-bit Integer",
            "description": "create a comprehensive function to print any integer from INT_MIN to INT_MAX",
            "skeleton_code": """
#include <stdio.h>
#include <limits.h>
...
"""
        ...
        {
            "title": "Print Integer Array",
            "description": "create a function to iterate through and print all elements of an integer array",
            "skeleton_code": """
#include <stdio.h>
#include <limits.h>
...
"""
        },
        {
            ...
            "description": "implement a function to find the indices of two array elements that add up to a target value",
            "skeleton_code": """
#include <stdio.h>
#include <limits.h>
...
"""
        ...
        {
            "title": "Print 8-bit Binary",
            "description": "create a function to convert an integer from 0 to 255 into an 8-bit binary string representation",
            "skeleton_code": """
#include <stdio.h>
#include <limits.h>
...
"""
        ...
        {
            "title": "Decode Binary String & Bitwise Operations",
            "description": "create a function to convert an 8-bit binary string back to decimal, and experiment with bitwise operators",
            "skeleton_code": """
#include <stdio.h>
#include <limits.h>
...
"""
        },
        {
            ...
            "description": "decrypt a secret message by manipulating the characters in a string array",
            "skeleton_code": """
#include <stdio.h>
#include <limits.h>
...
# 2. Navigate up one level, then into the 'data' folder
server_dir = os.path.join(script_dir, '..', 'data')
